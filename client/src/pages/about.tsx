                  ...
                  <CardContent className="pt-6">
                    ...
                    {member.socialLinks && (
                      <div className="flex space-x-3">
                        {JSON.parse(member.socialLinks as string).linkedin && (
                          <a
                            href={JSON.parse(member.socialLinks as string).linkedin}
                            target="_blank"
                        ...
                        {JSON.parse(member.socialLinks as string).twitter && (
                          <a
                            href={JSON.parse(member.socialLinks as string).twitter}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-slate-400 hover:text-primary"
